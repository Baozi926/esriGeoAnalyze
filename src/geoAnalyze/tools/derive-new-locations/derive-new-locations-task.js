define([
  ...
  var widget = declare([], {
          ...
          this
            ...
            .then(lang.hitch(this, function (res) {
              var event = arcgisUtil.watchJob(lang.mixin(param, {
                jobId: res.jobId
              }, {analyzeToolName: 'DeriveNewLocations'}));
    ...
    submitJob(param) {
      ...
      var dfd = new Deferred();
      var url = param.analyzeService + '/DeriveNewLocations/submitJob';
      var OutputName = {
        "serviceProperties": {
      ...
      var queryParam = {
        f: 'json',
        inputLayers: JSON.stringify(param.param.inputLayers),
        expressions: JSON.stringify(param.param.expressions),
